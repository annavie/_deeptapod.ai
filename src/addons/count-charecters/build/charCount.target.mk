...
TARGET := charCount
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=charCount' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/count-charecters.o
...
$(builddir)/charCount.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/charCount.node: LIBS := $(LIBS)
$(builddir)/charCount.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/charCount.node: TOOLSET := $(TOOLSET)
$(builddir)/charCount.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/charCount.node
# Add target alias
.PHONY: charCount
charCount: $(builddir)/charCount.node

# Short alias for building this executable.
.PHONY: charCount.node
charCount.node: $(builddir)/charCount.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/charCount.node
