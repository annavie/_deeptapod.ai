...
TARGET := countWords
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=countWords' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/count-words.o
...
$(builddir)/countWords.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/countWords.node: LIBS := $(LIBS)
$(builddir)/countWords.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/countWords.node: TOOLSET := $(TOOLSET)
$(builddir)/countWords.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/countWords.node
# Add target alias
.PHONY: countWords
countWords: $(builddir)/countWords.node

# Short alias for building this executable.
.PHONY: countWords.node
countWords.node: $(builddir)/countWords.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/countWords.node
