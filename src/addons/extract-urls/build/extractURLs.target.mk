...
TARGET := extractURLs
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=extractURLs' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/extract-urls.o
...
$(builddir)/extractURLs.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/extractURLs.node: LIBS := $(LIBS)
$(builddir)/extractURLs.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/extractURLs.node: TOOLSET := $(TOOLSET)
$(builddir)/extractURLs.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/extractURLs.node
# Add target alias
.PHONY: extractURLs
extractURLs: $(builddir)/extractURLs.node

# Short alias for building this executable.
.PHONY: extractURLs.node
extractURLs.node: $(builddir)/extractURLs.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/extractURLs.node
